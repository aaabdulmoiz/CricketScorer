...
<div class="wrapper">
    ...
    <div class="main-panel">
        ...
        <div>
            <?php
                $team=$_SESSION['team'];
                $s="Select team_name, username from teams where team_name!='$team'";
                ...
                <table class="table">
                    ...
                    <?php
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="scorervalidationpre.php?team_name=<?php echo $row['team_name'];?>" class="btn btn-primary">Challenge</a>
                            </td>
                        </tr>
                        <?php endwhile; ?>
                </table>
